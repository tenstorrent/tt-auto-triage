...
#
# Handles two paths:
#   1. Cancellation: when .regression_analysis/cancel.json exists and should_cancel=true
...
#
# Writes payload to .regression_analysis/slack_payload.json and appends to GITHUB_OUTPUT:
#   payload_file=...
...
# Optional env:
#   MESSAGE_PATH (default: .regression_analysis/output/slack_message.json)
...
MESSAGE_PATH="${MESSAGE_PATH-.regression_analysis/output/slack_message.json}"
PAYLOAD_FILE=".regression_analysis/slack_payload.json"
CANCEL_FILE=".regression_analysis/cancel.json"
ERROR_MSG_FILE=".regression_analysis/data/error_message.txt"
SUBJOB_RUNS_FILE=".regression_analysis/data/subjob_runs.json"
JOB_OWNER_FILE=".regression_analysis/data/job_owner.json"
...
RAW_MESSAGE=$(jq -r '.message // "Regression-analysis cancelled"' "$CANCEL_FILE")
...
SLACK_DATA_DIR=".regression_analysis/regression_analysis/data"
