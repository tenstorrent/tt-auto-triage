...
#
#   download_commit_batch "abc123" "def456" 0 "regression_handling/data/commit_info.json"
#
download_commit_batch() {
    local start_commit="$1" end_commit="$2" batch_idx="$3" output_file="${4:-regression_handling/data/commit_info.json}"
