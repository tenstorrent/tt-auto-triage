#!/bin/bash
#
# validation.sh - Input and output validation helpers for regression-handling
#
...
if [ -n "${_REGRESSION_HANDLING_VALIDATION_LOADED:-}" ]; then
    return 0
fi
_REGRESSION_HANDLING_VALIDATION_LOADED=1
...
#
#   validate_json_file "regression_handling/data/commit_info.json"
