...
# Run:  cd .github/actions/regression-analysis/regression_analysis && ./tests/modules/boundaries/workflow_finder_test.sh
#
...
# test-regression-analysis-lib.yml exists in tt-auto-triage (this repo)
wf_id=$(find_workflow_id "test-regression-analysis-lib")
assert "find_workflow_id: test-regression-analysis-lib" [ -n "$wf_id" ]
