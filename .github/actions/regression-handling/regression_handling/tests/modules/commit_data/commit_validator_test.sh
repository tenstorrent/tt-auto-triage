...
#
# Run: cd .github/actions/regression-handling/regression_handling && ./tests/modules/commit_data/commit_validator_test.sh
#
...
source "$AT_ROOT/modules/commit_data/commit_validator.sh"
