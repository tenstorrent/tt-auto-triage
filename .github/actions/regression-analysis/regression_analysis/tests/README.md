...
All tests via CI: see `.github/workflows/test-regression-analysis-lib.yml`

## CI Integration

The workflow `test-regression-analysis-lib.yml` runs all `*_test.sh` files matching:
- `tests/lib/*_test.sh`
