...
Usage:
  ./regression_handling/get_slack_ids.py "Alice Smith" --directory regression_handling/data/slack_directory.json
...
Optional flags:
  ...
  --directory PATH Path to the JSON directory (default: regression_handling/data/slack_directory.json).
"""
...
DEFAULT_DIRECTORY = "regression_handling/data/slack_directory.json"
