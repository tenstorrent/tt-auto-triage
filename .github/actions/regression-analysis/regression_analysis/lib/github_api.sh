#!/bin/bash
#
# github_api.sh - GitHub API wrapper functions for regression-analysis
#
...
if [ -n "${_REGRESSION_ANALYSIS_GITHUB_API_LOADED:-}" ]; then
    return 0
fi
_REGRESSION_ANALYSIS_GITHUB_API_LOADED=1
