...
All tests via CI: see `.github/workflows/test-regression-handling-lib.yml`

## CI Integration

The workflow `test-regression-handling-lib.yml` runs all `*_test.sh` files matching:
- `tests/lib/*_test.sh`
