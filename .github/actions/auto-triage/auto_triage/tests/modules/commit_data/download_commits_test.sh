...
# -- multi-batch (> 10 commits) returns 0, sets BATCH_NEEDED=1 and BATCH_COUNT ---
...
assert_eq "multi-batch returns 0 (success, need batches)" "$ret_multi" "0"
assert "multi-batch sets BATCH_NEEDED=1" [ "${BATCH_NEEDED:-0}" -eq 1 ]
