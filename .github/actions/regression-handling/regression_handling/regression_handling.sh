...
# Usage: ./regression_handling.sh <workflow_name> <subjob_name> [ci-mode]
#
...
SUBJOB="$2"
CI_MODE="${3:-}"
ROOT="$REGRESSION_HANDLING_ROOT"

log_info "Preparing regression_handling/data and regression_handling/logs"
