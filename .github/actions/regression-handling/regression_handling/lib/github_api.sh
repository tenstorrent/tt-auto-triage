#!/bin/bash
#
# github_api.sh - GitHub API wrapper functions for regression-handling
#
...
if [ -n "${_REGRESSION_HANDLING_GITHUB_API_LOADED:-}" ]; then
    return 0
fi
_REGRESSION_HANDLING_GITHUB_API_LOADED=1
