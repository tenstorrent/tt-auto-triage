...
# Run:  cd .github/actions/regression-analysis/regression_analysis && ./tests/lib/config_test.sh
#
...
(
    ...
    unset _REGRESSION_ANALYSIS_CONFIG_LOADED
    source "$AT_ROOT/lib/config.sh"
...
assert "data dir created"   test -d "$TMP_ROOT/regression_analysis/data"
assert "logs dir created"   test -d "$TMP_ROOT/regression_analysis/logs"
assert "output dir created" test -d "$TMP_ROOT/regression_analysis/output"
