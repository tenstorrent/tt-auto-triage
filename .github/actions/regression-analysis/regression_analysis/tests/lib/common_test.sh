...
# Run:  cd .github/actions/regression-analysis/regression_analysis && ./tests/lib/common_test.sh
#
...
# -- root detection -----------------------------------------------------------
assert "REGRESSION_ANALYSIS_ROOT is set" test -n "$REGRESSION_ANALYSIS_ROOT"

# -- path helpers -------------------------------------------------------------
assert_eq "get_data_dir"            "$(get_data_dir)"            "$REGRESSION_ANALYSIS_ROOT/regression_analysis/data"
assert_eq "get_output_dir"          "$(get_output_dir)"          "$REGRESSION_ANALYSIS_ROOT/regression_analysis/output"
assert_eq "get_logs_dir"            "$(get_logs_dir)"            "$REGRESSION_ANALYSIS_ROOT/regression_analysis/logs"
assert_eq "get_data_dir custom root" "$(get_data_dir /tmp/foo)"  "/tmp/foo/regression_analysis/data"
