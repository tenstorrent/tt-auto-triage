...
# Optional env:
#   JOB_OWNER_FILE (default: .regression_analysis/data/job_owner.json)
#   SLACK_DATA_DIR (default: .regression_analysis/regression_analysis/data)
#

set -uo pipefail

JOB_OWNER_FILE="${JOB_OWNER_FILE:-.regression_analysis/data/job_owner.json}"
SLACK_DATA_DIR="${SLACK_DATA_DIR:-.regression_analysis/regression_analysis/data}"
