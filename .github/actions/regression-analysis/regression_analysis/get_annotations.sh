...
#
# Writes failure/error annotations to output_file (default: regression_analysis/logs/job_<id>/annotations.json).
#
...
OUTPUT_FILE="${2:-regression_analysis/logs/job_${JOB_ID}/annotations.json}"
