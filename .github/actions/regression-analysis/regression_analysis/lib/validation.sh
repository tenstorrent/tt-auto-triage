#!/bin/bash
#
# validation.sh - Input and output validation helpers for regression-analysis
#
...
if [ -n "${_REGRESSION_ANALYSIS_VALIDATION_LOADED:-}" ]; then
    return 0
fi
_REGRESSION_ANALYSIS_VALIDATION_LOADED=1
...
#
#   validate_json_file "regression_analysis/data/commit_info.json"
